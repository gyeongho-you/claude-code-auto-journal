...
날짜/프로젝트 목록 화면(맨 처음 화면)에서 `s`를 누르면 특정 파일이 아닌 **저장된 모든 기록**을 대상으로 검색합니다. 최초 검색 시 전체 기록을 스캔하므로 기록량에 따라 약간의 지연이 있을 수 있습니다.

```
📂 [전체검색] "lambda"   결과 32/58건   [프로젝트: 전체]  [기간: 최근 30일]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
▷ 2026-06-04 · aws_personalized · ...lambda 함수 배포 시 콜드스타트 이슈 해결...
  2026-05-28 · my-project        · ...lambda 권한 정책 수정 후 재배포...
  ...
─────────────────────────────────────────────────────────
▲▼ 이동  /  enter 상세보기  /  p 프로젝트필터  /  d 기간필터  /  s 재검색  /  esc 취소  /  q 종료
```

- 검색은 질문(prompt)·응답(answer)을 대상으로 하며, 결과는 최신순 정렬. 매치 건수 제한 없이 전체가 표시되며 `↑↓`로 끝까지 스크롤 가능
